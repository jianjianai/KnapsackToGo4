    ...
    static void load() throws ConfigLoadException, DataCaseLoadError {
        try {
            if (playerDataCase==null){
                ...
                try {
                    playerDataCase = YamlConfig.loadFromFile(new File(KnapsackToGo4.INSTANCE.getDataFolder(),"PlayerDataConfig.yml"), new PlayerDataSettings()).playerDataCaseType;
                    ...
                    throw new NoOptionsError(e,"加载配置文件PlayerDataConfig.yml中"+playerDataCase+"值不存在！");
                }
            } else {
            ...
            if (playerDataSerialize==null){
                ...
                try {
                    playerDataSerialize = YamlConfig.loadFromFile(new File(KnapsackToGo4.INSTANCE.getDataFolder(),"PlayerDataConfig.yml"), new PlayerDataSettings()).playerDataSerializeType;
                    ...
                    throw new NoOptionsError(e,"加载配置文件PlayerDataConfig.yml中"+playerDataSerialize+"值不存在！");
                }
            }else {
